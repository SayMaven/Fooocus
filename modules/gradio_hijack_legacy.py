...
if hasattr(EventListenerMethod, '__call__') and not hasattr(EventListenerMethod, '_original_call'):
    EventListenerMethod._original_call = EventListenerMethod.__call__
    def safe_elm_call(self, *args, **kwargs):
        if 'js' in kwargs and '_js' not in kwargs:
            kwargs['_js'] = kwargs.pop('js')
        return EventListenerMethod._original_call(self, *args, **kwargs)
    EventListenerMethod.__call__ = safe_elm_call
